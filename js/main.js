    ...
    btn.onclick = function() {
        ...
        if (firstElm){
            ...
            if (id == "bebb"){
                ...
                desc.innerHTML = "<li><b>Scientific Name:</b> Scolytus schevyrewi</li><li><b>Affects:</b> Elm Species</li><li><b>Native to:</b> northern China, central Asia, and Russia</li><li>The Banded Elm Bark Beetle likely arrived on shipping pallets or containers and was first discovered in 2003 in Colorado and Utah. "
            } else if (id == "bc") {
                title.innerHTML = "<h5>Butternut Canker</h5>"
                desc.innerHTML = "<li><b>Scientific Name:</b> Sirococcus clavigignenti juglandacearum</li><li><b>Affects:</b> Butternut Species (severely) and other members of the Juglans genus</li><li><b>Native to:</b> Asia</li><li>The Butternut Canker is depleting already sparse populations of Butternuts in the eastern US. This fungal disease affects all above-ground portions of the tree and can eventually lead to death.</li>"

            } else if (id == "eab") {
                title.innerHTML = "<h5>Emerald Ash Borer</h5>"
                desc.innerHTML = "<li><b>Scientific Name:</b> Agrilus planipennis</li><li><b>Affects:</b> Ash Species</li><li><b>Native to:</b> Asia</li><li>The Emerald Ash Borer was discovered in North America in 2002 in Detroit. It's spread since that time has been largely aided by human activity such as the movement of nursery trees and logs for firewood.</li>" 

            } else if (id == "gm") {
                title.innerHTML = "<h5>Gypsy Moth</h5>"
                desc.innerHTML = "<li><b>Scientific Name:</b> Lymantria dispar</li><li><b>Affects:</b> Most Deciduous Trees and Shrubs</li><li><b>Native to:</b> temperate Europe and Asia</li><li>The Gypsy Moth was introduced in the Northeastern United states in the mid-1800s. The larvae cause extreme damage to foliage by feeding on leaves. </li>"
            } else if (id == "hwa") {
                title.innerHTML = "<h5>Hemlock Woolly Adelgid</h5>"
                desc.innerHTML = "<li><b>Scientific Name:</b> Adelges tsugae</li><li><b>Affects:</b> Eastern and Carolina Hemlocks</li><li><b>Native to:</b> Asia</li><li>The Hemlock Woolly Adelgid has caused devastation to Hemlocks in the northeastern United States. It depletes nutrients from the base of the tree's needles. Warmer winters make Hemlocks in the Southern US more likely to die from the pest.</li>"
            } else if (id == "jb") {
                title.innerHTML = "<h5>Japanese Beetle </h5>"
                desc.innerHTML = "<li><b>Scientific Name:</b> Popillia japonica</li><li><b>Affects:</b> Many Species of Trees, Shrubs, and Garden Crops</li><li><b>Native to:</b> Japan</li><li>The Japanese Beetle is a double threat. Its larva feed on the root system of trees and plants while the adults do severe damage above ground. It was first discovered in New Jersey in 1916 and is a major threat to American crops.</li>"
            } else if (id == "wpbr") {
                title.innerHTML = "<h5>White Pine Blister Rust </h5>"
                desc.innerHTML = "<li><b>Scientific Name:</b> Cronartium ribicola</li><li><b>Affects:</b> Pines and White Pines</li><li><b>Native to:</b> Asia</li><li>The White Pine Blister Rust has very specific reproductive needs but spores can be easily spread. The entire life cycle last 3 to 6 years. The fungus causes swelling and cankers which can kill branches and entire trees.</li>"
            } else {
                // if the id is none 
